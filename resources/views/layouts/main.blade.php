  ...
  <body>
    <style>
      *{
      ...
      #particles-js{ position:absolute; width: 100vw; height: 100vh; background-color: #ffffff; ; background-repeat: no-repeat; background-size: cover; background-position: 50% 50%; } /* ---- stats.js ---- */ 
